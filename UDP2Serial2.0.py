...
def Serial2UDP():
    while True:
        locka.acquire()
        result = ser.read(100)
        print("收到串口信息:",result.hex(' '))
        server_socket.sendto(result, ("127.0.0.1", 10003))
        print ("发送: %x",result.hex(' '))
        locka.release()
...
if __name__ == "__main__":
      ...
      ta = threading.Thread(None, UDP2Serial)
      tb = threading.Thread(None, Serial2UDP)
